...
const SVC_URL = "https://appadaycreator.com/relationship-compatibility/";
const SVC_NAME = "相性診断ツール";

test.describe("相性診断ツール - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("relationship-compatibility");
